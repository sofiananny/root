      ...
      <form id="order_data" action="order/validate">
        <div id="step1" class="step">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group row">
                <label class="col-sm-2 control-label">Квартал</label>
                <div class="col-sm-10">
...
<?php echo $districts; ?>
          ...
          <div class="row">
            <label class="col-lg-1 hidden-md hidden-sm hidden-xs"></label>
            <div class="col-lg-11">
              <textarea id="note" class="form-control" name="note" style="resize: none;" placeholder="Допълнително описание"
                        ><?php echo $_SESSION['order']['note']; ?></textarea>
            </div>
          </div>
        </div>
            ...
            <div class="col-md-7">
              <div class="col-sm-6 form-group">
                ...
                <div class="col-sm-8 input-group input-append date">
                  <input id="date" type="text" class="form-control" name="date" readonly style="background-color: #FFF;"
                         value="<?php echo $_SESSION['order']['date']; ?>"/>
              ...
              <div class="col-sm-6 form-group">
                ...
                <div class="col-lg-5 col-sm-6 input-group clockpicker" data-placement_="" data-align="top" data-autoclose="true">
                  <input id="time" class="form-control" type="text" name="time" readonly style="background-color: #FFF;"
                         value="<?php echo $_SESSION['order']['time']; ?>"/>
                  <span class="input-group-addon" onclick="$('#time').focus()" style="cursor: pointer">
                    <span class="glyphicon glyphicon-time"></span>
                  </span>
                </div>
                <span class="help-block pull-right">Посочете час м/у 7<sup>00</sup> и 22<sup>00</sup> ч.!</span>
              </div>
            </div>
            <div class="col-md-5">
              <div class="form-group">
                ...
                <div class="col-lg-7 col-md-6 col-sm-8">
                  <select id="duration" class="form-control" type="text" name="duration" style="padding-right: 0;">
                    <option class="form-control" style="display: none;" value="0">0 часа</option>
...
<?php } ?>                
      ...
      <a id="next" class="btn btn-login fw pull-right" onclick="next(2);" style="width: 110px;">продължи</a>
